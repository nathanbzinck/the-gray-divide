      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="text-right">
            <p className="text-xl font-semibold">
              ...
              {character.alias && <span className="text-gray-400"> "{character.alias}"</span>}
            </p>
            <p className={`text-sm ${factionColors[character.current_faction]}`}>
              {character.current_faction === "neutral" ? "Unaligned" : character.current_faction.replace("_", " ")}
            </p>
            <button
              onClick={async () => {
                const supabase = createClient();
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-gray-800 p-4 rounded-lg text-center">
            ...
            <p className="text-2xl font-bold text-orange-400">{character.heat}%</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          <div className="bg-gray-800 p-4 rounded-lg">
            ...
            <p className="text-2xl font-bold text-green-400">${character.clean_money.toLocaleString()}</p>
          </div>
          <div className="bg-gray-800 p-4 rounded-lg">
            <p className="text-gray-400 text-sm">Dirty Money</p>
            <p className="text-2xl font-bold text-red-400">${charac